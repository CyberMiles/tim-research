...
= Conclusion
Both, base layer protocol and second layer protocol, solutions to blockchain scaling are in their infancy (in the experimental research and development phase). 
