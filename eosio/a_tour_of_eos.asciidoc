...
=== Proof of completeness (finality)
...
Let us consider the ever changing account balance.  A light client might like to query the account balance to ensure that the user has enough money to perform a transaction. This is where it gets interesting. The following section explains the double spend attack, replay protection and 
