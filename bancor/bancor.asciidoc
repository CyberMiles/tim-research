...
The output from the following command is used to create the abi variable i.e. 
...
The output from the following command is used to create the bytecode variable i.e. 

[source, javascript]
----
var bytecode = "608060405260408051908101604052 ... fe49f9e0029"
----
