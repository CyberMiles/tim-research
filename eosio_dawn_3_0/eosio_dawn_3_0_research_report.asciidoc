...
One of the most important differences in running on a real testnet, as apposed to running a single private EOSIO blockchain, is how the wallet is created and configured.
