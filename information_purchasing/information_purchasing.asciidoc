= Information purchasing: Research and development into the providing a practical mechanism to securly purchase sensitive and valuable information using blockchain technology.
